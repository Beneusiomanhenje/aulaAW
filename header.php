<?php 
$base_user = 'http://localhost/beneusio/';
...
<head>
<base href="http://localhost/beneusio/">
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Benéusio Manhenje</title>
    <!-- ================= Favicon ================== -->
    <!-- Standard -->
        ...
        <div class="nano">
            <div class="nano-content">
                <ul>
                    ...
                    <li><a href="home.php" class="sideba"><i class="ti-home"></i> Dashboard</a></li>
                    <li class="label">Apps</li>
                    <li><a class="sidebar-sub-toggle"><i class="ti-bar-chart-alt"></i> Usuarios <span
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="float-right">
                        ...
                        <div class="dropdown dib">
                            <div class="header-icon" data-toggle="dropdown">
                                <span class="user-avatar">Benéusio Manhenje
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Olá, <span>Seja Bem-Vindo!</span></h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
